...
> - **Tables included:** TBL-STRAT-PARTNER
> - **Next suggested refresh date:** 2026-09-10


This module applies the repository's evidence ladder to partner decisions. Every action requires a named capability gap, XPU win-rate mechanism, technical feasibility, time-to-market, cost and risk, dependencies, evidence confidence and next diligence questions. [[SRC-MRVL-001]](../data/source_database.yaml) [[SRC-IEEE-001]](../data/source_database.yaml)
