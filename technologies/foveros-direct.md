...
> **Section metadata**
> - **Section title:** Intel Foveros and Foveros Direct
...
| Current maturity | production and ramping | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Active base-die stacking with micro-bumps or direct bonding.
- **Current maturity:** production and ramping.
- **Key bottlenecks:** external access, thermal, test.
- **Leading vendors:** Intel.
...
- **Figures and tables included:** FIG-MMD-010, TBL-TECH-010.
