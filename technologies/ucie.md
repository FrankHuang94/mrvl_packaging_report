...
| Current maturity | specification and early products | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Open package-level die-to-die protocol and physical interface.
- **Current maturity:** specification and early products.
- **Key bottlenecks:** interoperability, latency overhead, test.
- **Leading vendors:** UCIe Consortium, Synopsys, Cadence.
...
- **Figures and tables included:** FIG-MMD-016, TBL-TECH-016.
