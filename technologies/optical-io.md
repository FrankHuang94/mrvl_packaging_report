# Optical I/O Chiplets for XPUs


> **Section metadata**
> - **Section title:** Optical I/O Chiplets for XPUs
...
| Current maturity | development | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** In-package optical chiplets connecting compute to rack-scale fabrics.
- **Current maturity:** development.
- **Key bottlenecks:** fiber attach, test, protocol integration.
- **Leading vendors:** Marvell, Ayar Labs, Lightmatter, Ranovus.
...
- **Figures and tables included:** FIG-MMD-020, TBL-TECH-020.
