...
> **Section metadata**
> - **Section title:** Custom HBM Base Die
...
| Current maturity | announced architecture | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Customer-specific logic base die that can partition PHY, control and data movement.
- **Current maturity:** announced architecture.
- **Key bottlenecks:** business model, memory-vendor interfaces, verification.
- **Leading vendors:** Marvell, memory vendors, TSMC.
...
- **Figures and tables included:** FIG-MMD-015, TBL-TECH-015.
