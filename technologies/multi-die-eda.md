# Multi-Die EDA and Multi-Physics


> **Section metadata**
> - **Section title:** Multi-Die EDA and Multi-Physics
...
| Current maturity | production and maturing | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Integrated die-package-board electrical, thermal and mechanical design flow.
- **Current maturity:** production and maturing.
- **Key bottlenecks:** data model integration, runtime, correlation.
- **Leading vendors:** Cadence, Synopsys, Siemens, Ansys.
...
- **Figures and tables included:** FIG-MMD-026, TBL-TECH-026.
