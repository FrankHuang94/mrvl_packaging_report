# ABF Organic Substrate


> **Section metadata**
> - **Section title:** ABF Organic Substrate
...
| Competitive threat | 4/5 | Measures the risk that competitors control scarce capability or create a proprietary platform advantage. |
| Partnership potential | 4/5 | Measures the value of ecosystem access, co-development and multi-source leverage. |
| Current maturity | high-volume production | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Build-up organic package substrate used under advanced interposers.
- **Current maturity:** high-volume production.
- **Key bottlenecks:** capacity, warpage, large-body yield.
- **Leading vendors:** Ibiden, Shinko, Unimicron, Kinsus, AT&S.
...
- **Figures and tables included:** FIG-MMD-022, TBL-TECH-022.
