# Known-Good-Die and Chiplet Test


> **Section metadata**
> - **Section title:** Known-Good-Die and Chiplet Test
...
| Current maturity | production and evolving | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Pre-bond, mid-bond and final test strategy for multi-die packages.
- **Current maturity:** production and evolving.
- **Key bottlenecks:** coverage, DFT standards, repair.
- **Leading vendors:** ASE, Amkor, KYEC, foundries.
...
- **Figures and tables included:** FIG-MMD-025, TBL-TECH-025.
