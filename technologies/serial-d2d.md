# Serialized XSR/USR Die-to-Die


> **Section metadata**
> - **Section title:** Serialized XSR/USR Die-to-Die
...
- **Why it matters:** Narrower high-speed SerDes link for longer package reach and modularity.
- **Current maturity:** production and development.
- **Key bottlenecks:** energy per bit, latency, clocking.
- **Leading vendors:** Marvell, Alphawave, Synopsys.
...
- **Figures and tables included:** FIG-MMD-018, TBL-TECH-018.
