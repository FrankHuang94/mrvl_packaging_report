...
> **Section metadata**
> - **Section title:** Switch Co-Packaged Optics
...
| Current maturity | announced and early deployment | Separates production evidence from announced targets and research concepts. |
...
- **Why it matters:** Optical engines adjacent to a switch ASIC.
- **Current maturity:** announced and early deployment.
- **Key bottlenecks:** serviceability, laser reliability, thermal isolation.
- **Leading vendors:** NVIDIA, Broadcom, Marvell.
...
- **Figures and tables included:** FIG-MMD-019, TBL-TECH-019.
