# AI Training Hyperscaler


> **Section metadata**
> - **Section title:** AI Training Hyperscaler
...
> - **Tables included:** TBL-USE-AI-TRAINING-HYPERSCALER
> - **Next suggested refresh date:** 2026-09-10


Maximum HBM bandwidth, scale-up bandwidth and rack density; tolerates high package cost when time-to-train dominates. Packaging selection should rank HBM capacity and bandwidth, power efficiency, rack density, yielded cost, time-to-market, software coupling, supply resilience and thermal serviceability. Marvell should present at least two architecture points: a performance-maximized package and a cost/supply-optimized package. [[SRC-MRVL-001]](../data/source_database.yaml) [[SRC-NVIDIA-001]](../data/source_database.yaml)
