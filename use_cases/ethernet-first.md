# Ethernet-First Hyperscaler


> **Section metadata**
> - **Section title:** Ethernet-First Hyperscaler
...
> - **Tables included:** TBL-USE-ETHERNET-FIRST
> - **Next suggested refresh date:** 2026-09-10


Prioritizes open scale-out, switch economics and operational familiarity. Packaging selection should rank HBM capacity and bandwidth, power efficiency, rack density, yielded cost, time-to-market, software coupling, supply resilience and thermal serviceability. Marvell should present at least two architecture points: a performance-maximized package and a cost/supply-optimized package. [[SRC-MRVL-001]](../data/source_database.yaml) [[SRC-NVIDIA-001]](../data/source_database.yaml)
